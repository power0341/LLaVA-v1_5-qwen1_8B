...
class ModelArguments:
    ...
    mm_unfreeze_position_embedding: bool = field(default=False)
    mm_use_im_start_end: bool = field(default=False)
    mm_use_im_patch_token: bool = field(default=True)
    mm_vision_select_feature: Optional[str] = field(default="patch")
    resampler_seq_len: Optional[int] = field(default=64)
    resampler_embed_dim: Optional[int] = field(default=2048)
    resampler_num_heads: Optional[int] = field(default=8)
    resampler_kv_dim: Optional[int] = field(default=1024)
...
def train():
    ...
    if local_rank == 0:
        import pickle
        pickle.dump(data_module, open('ds.pkl', 'wb'))
    #--------------------------------------------------------------#
