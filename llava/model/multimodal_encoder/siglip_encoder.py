...
class SiglipVisionTower(nn.Module):
    def __init__(self, image_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = SiglipVisionConfig.from_pretrained(self.image_tower_name)
    ...
    def load_model(self, device_map=None):
        ...
        self.image_tower = SiglipVisionModel.from_pretrained(self.image_tower_name, device_map=device_map)
